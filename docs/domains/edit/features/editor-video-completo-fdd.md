...
- Item de `overlay`: além de `src`/`clip`/`mediaId`, preserva `shape` (glifo do painel Elementos, ≤ 16 chars) e `text` (rótulo do elemento na timeline, ≤ 5000) quando presentes.
